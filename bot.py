...
from handlers import admin_handlers, other_handlers, raffle_handlers, user_handlers
from keyboards.main_menu import set_main_menu

from configuration.config import ConfigBot, ConfigDB, load_config_bot, load_config_db
...
async def main():
    ...
    logger.info('Инициализировано соединение СУБД ')
    ...
    dp = Dispatcher(storage=storage, db_engine=db_engine, fsm_strategy=FSMStrategy.CHAT)
